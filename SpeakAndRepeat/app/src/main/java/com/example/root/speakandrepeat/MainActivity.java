package com.example.root.speakandrepeat;
...
//            //start the checking Intent - will retrieve result in onActivityResult
        ...
        wordList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Toast.makeText(getApplicationContext(), "You said: "+wordChosen, Toast.LENGTH_SHORT).show();//**alter for your Activity name***
            }
        });
    }
...
//        //start the checking Intent - will retrieve result in onActivityResult
//        startActivityForResult(checkTTSIntent, MY_DATA_CHECK_CODE);
//        repeatTTS.speak("Did you say" + suggestedWords.get(0) + "?" + "Please answer yes, no or more choices", TextToSpeech.QUEUE_FLUSH, null);
//    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == VR_REQUEST && resultCode == RESULT_OK)
        {
            if (!secondChoice) {
                ...
                outputSpeech = "Did you say"+suggestedWords.get(0)+"?"+"Please answer yes, no or more choices";
                repeatTTS.speak(outputSpeech, TextToSpeech.QUEUE_FLUSH, null);
                secondChoice = true;
                try {
                    Thread.sleep(8000);                 //1000 milliseconds is one second.
                    Log.d("onActivityResult ","delay success");
                ...
                Log.d("onActivityResult", "get into second answer");
                ArrayList<String>  suggestedCommand= data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                Log.d("onActivityResult", suggestedCommand.get(0));
