...
public class OrientationSensor implements SensorEventListener {
    ...
    public OrientationSensor(SensorManager sm, SensorEventListener parent, Context context) {
        m_sm = sm;
        m_parent = parent;
        m_activity = null;
    ...
    public int Register(Activity activity, int sensorSpeed) {
        ...
        yaw = (TextView)activity.findViewById(R.id.Yaw);
        pitch = (TextView)activity.findViewById(R.id.Pitch);
    ...
    public void onSensorChanged(SensorEvent evnt) {
        ...
        if (m_NormGravityVector != null && m_NormMagFieldValues != null) {
            ...
            if (m_Norm_Gravity * m_Norm_MagField * norm_East < 0.1f) {  // Typical values are  > 100.
                ...
                yaw.setText("YAW:" + m_azimuth_radians);
                pitch.setText("PITCH:" + m_pitch_axis_radians);
            }
        }
